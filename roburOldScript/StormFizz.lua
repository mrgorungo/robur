--[[
 ____    __                                 ____                          
/\  _`\ /\ \__                             /\  _`\   __                   
\ \,\L\_\ \ ,_\  _ __   ___     ___ ___    \ \ \L\_\/\_\  ____    ____    
 \/_\__ \\ \ \/ /\`'__\/ __`\ /' __` __`\   \ \  _\/\/\ \/\_ ,`\ /\_ ,`\  
   /\ \L\ \ \ \_\ \ \//\ \L\ \/\ \/\ \/\ \   \ \ \/  \ \ \/_/  /_\/_/  /_ 
   \ `\____\ \__\\ \_\\ \____/\ \_\ \_\ \_\   \ \_\   \ \_\/\____\ /\____\
    \/_____/\/__/ \/_/ \/___/  \/_/\/_/\/_/    \/_/    \/_/\/____/ \/____/
                                                                                                                                 
]]
if Player.CharName ~= "Fizz" then return end
--[[ require ]]
require("common.log")
module("Storm Fizz", package.seeall, log.setup)
clean.module("Storm Fizz", clean.seeall, log.setup)
--[[ SDK ]]
local SDK         = _G.CoreEx
...
function Fizz.LoadMenu()
    Menu.RegisterMenu("StormFizz", "Storm Fizz", function()
