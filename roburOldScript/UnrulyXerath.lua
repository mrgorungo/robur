...
function Xerath.LoadMenu()
    Menu.RegisterMenu("UnrulyXerath", "Unruly Xerath", function()
        Menu.ColumnLayout("cols", "cols", 2, true, function()
            ...
            Menu.Slider("Combo.ChanceQ", "HitChance [Q]", 0.75, 0, 1, 0.1)
            Menu.Checkbox("Combo.UseW", "Use [W]", true)
            Menu.Slider("Combo.ChanceW", "HitChance [W]", 0.75, 0, 1, 0.1)
            Menu.Checkbox("Combo.UseE", "Use [E]", true)
            Menu.Slider("Combo.ChanceE", "HitChance [E]", 0.9, 0, 1, 0.1)
            Menu.Checkbox("Combo.UseR", "Use [R]", true)
            Menu.Slider("Combo.ChanceR", "HitChance [R]", 0.75, 0, 1, 0.1)
            ...
            Menu.Slider("Harass.ChanceQ", "HitChance [Q]", 0.75, 0, 1, 0.1)
            Menu.Checkbox("Harass.UseW", "Use [W]", true)
            Menu.Slider("Harass.ChanceW", "HitChance [W]", 0.75, 0, 1, 0.1)
            Menu.Checkbox("Harass.UseE", "Use [E]", true)
            Menu.Slider("Harass.ChanceE", "HitChance [E]", 0.9, 0, 1, 0.1)
        end) 

        Menu.Separator()
        Menu.ColumnLayout("cols2", "cols2", 3, true, function()
            Menu.ColoredText("Last Hit", 0xFFD700FF, true)
            ...
            Menu.NextColumn()
            Menu.ColoredText("Lane Clear", 0xFFD700FF, true)
            ...
            Menu.NextColumn()
            Menu.ColoredText("Jungle Clear", 0xFFD700FF, true)
        ...
        Menu.Dropdown("Misc.ModeR", "Use [R] Mode", 0, Xerath.ModesR) 
