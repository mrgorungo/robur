...
require("common.log")
module("Storm Alistar", package.seeall, log.setup)
clean.module("Storm Alistar", clean.seeall, log.setup)
...
function Alistar.OnGapclose(Source, DashInstance)
    ...
    if Dist < W.Range and Menu.Get(Source.AsHero.CharName) then
...
function Alistar.LoadMenu()
    Menu.RegisterMenu("StormAlistar", "Storm Alistar", function()
